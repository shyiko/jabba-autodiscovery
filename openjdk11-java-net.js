...
const baseURL = 'https://download.java.net/java/early_access/jdk11'
    ...
    function resolve(v) {
      fetch(`http://download.java.net/java/early_access/jdk11/${v}/BCL/jre-11-ea+${v}_windows-x64_bin.exe.sha256`,
        ...
        .then((res) => {
          if (res.ok) {
            ee.push(
              {os: 'darwin', arch: 'amd64', version: `1.11.0-${v}`, url: `${baseURL}/${v}/GPL/openjdk-11-ea+${v}_osx-x64_bin.tar.gz`},
              // {os: 'linux', arch: '386', version: `1.10.0-${v}`, url: `${baseURL}/${v}/BCL/jdk-9+${v}_linux-x86_bin.tar.gz`},
              {os: 'linux', arch: 'amd64', version: `1.11.0-${v}`, url: `${baseURL}/${v}/GPL/openjdk-11-ea+${v}_linux-x64_bin.tar.gz`},
              {os: 'windows', arch: 'amd64', version: `1.11.0-${v}`, url: `${baseURL}/${v}/GPL/openjdk-11-ea+${v}_windows-x64_bin.tar.gz`}
